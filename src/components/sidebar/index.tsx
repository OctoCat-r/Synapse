  ...
  return (
    <nav className="dark:bg-black h-screen overflow-scroll justify-between flex items-center flex-col gap-10 py-6 px-2">
      <div className="flex items-center justify-center flex-col gap-8">
        <Link href="/" className="flex flex-row mt-4">
          <Image src="/logo1.png" alt="alt" width={120} height={120} />
        </Link>
        <TooltipProvider>
        ...
        <Separator />
        {/* Scrollable rounded area looks great can use somewhere else also */}
